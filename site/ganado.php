...
$this->title = "Lácteos y Quesos | Airehcel Principal";

/* === CSS & JS === */
$this->registerJsFile("@web/js/script.js", ['depends' => [\yii\web\JqueryAsset::class]]);
$this->registerJsFile("@web/js/carrusel.js", ['depends' => [\yii\web\JqueryAsset::class]]);
?>
<link rel="stylesheet" href="<?= Yii::getAlias('@web/css/estilos.css') ?>">
...
<div class="user-menu">
    ...
    <h1>Bienvenidos a Láteos y Quesos Don Joaquin</h1>
...
<main>
    <div class="tab-container1">
        ...
        <div class="tab-buttons">
            <button class="tab-btn active" onclick="openTab(event, 'tab1')">Razas de Ganado</button>
            <button class="tab-btn" onclick="openTab(event, 'tab2')">Código de Ganado</button>
            <button class="tab-btn" onclick="openTab(event, 'tab3')">Dashboard de producción</button>
            <button class="tab-btn" onclick="openTab(event, 'tab4')">Calendario de salud</button>
        </div>
...
<footer>
    ...
    <img src="<?= Yii::$app->request->baseUrl ?>/images/logos/Logo-Lacteos-Quesos-Don-Joaquin.png" class="logo-header">
        <div class="footer-col">
            <h3>Lácteos y Quesos Don Joaquin</h3>
            <p>Elaboramos productos artesanales con el sabor fresco.</p>
        </div>
    ...
    <div class="footer-bottom">
        <p>&copy; 2025 Lácteos y Quesos Don Joaquin. Todos los derechos reservados.</p>
    </div>
</footer>