...
<link rel="stylesheet" href="<?= Yii::$app->request->baseUrl ?>/css/contactos.css">
...
<img src="<?= Yii::$app->request->baseUrl ?>/images/stock/vaca_gafas.jpeg" 
             alt="vaca con gafas de sol" class="imagen_vaca_gafas">

    <div class="contactos-texto">
        <p>
            En L&aacute;cteos y Quesos Don Joaqu&iacute;n valoramos la comunicaci&oacute;n cercana con nuestros clientes,
            distribuidores y productores aliados. Nos enorgullece mantener un trato directo y transparente con todas
            las personas que forman parte de nuestra comunidad.
        </p>

        <p>
            Si deseas realizar consultas sobre nuestros productos, conocer puntos de venta, recibir informaci&oacute;n
            comercial o establecer una colaboraci&oacute;n, estaremos encantados de atenderte. Nuestro equipo trabaja
            con dedicaci&oacute;n para brindarte asistencia oportuna y confiable.
        </p>

        <p>
            Puedes comunicarte con nosotros por tel&eacute;fono, correo electr&oacute;nico o a trav&eacute;s de nuestras
            redes sociales oficiales. A continuaci&oacute;n encontrar&aacute;s los enlaces para mantenerte en contacto con
            Lecher&iacute;as Don Joaqu&iacute;n Panam&aacute;:
        </p>

        <div class="contactos-redes">
            <a href="https://www.facebook.com/donjoaquinlacteos/" target="_blank">
                <img src="<?= Yii::$app->request->baseUrl ?>/images/icons/facebook.png" alt="Facebook">
            </a>
            <a href="https://www.instagram.com/donjoaquinlacteos/" target="_blank">
                <img src="<?= Yii::$app->request->baseUrl ?>/images/icons/instagram.png" alt="Instagram">
            </a>
        </div>
    </div>
</div>
