...
<link rel="stylesheet" href="<?= Yii::$app->request->baseUrl ?>/css/nosotros.css">
...
<main>
    <div class="historia-titulo">
        <h2>L&aacute;cteos Don Joaqu&iacute;n</h2>
        <h3>Nuestra Historia</h3>
    </div>

    <div class="historia-contenedor">

        <img src="<?= Yii::$app->request->baseUrl ?>/images/stock/revision_vacas.png" 
             alt="persona revisando vacas" class="imagen_revision">

        <div class="historia-texto">
            <p>
                En Don Joaqu&iacute;n somos una empresa familiar paname&ntilde;a, fundada en 2001 en Concepci&oacute;n, Chiriqu&iacute;, 
                con el sue&ntilde;o de producir l&aacute;cteos artesanales de primera calidad. Lo que comenz&oacute; como unos cuantos 
                quesos caseros, elaborados por Martha Zulay Campa&ntilde;a y Pedro De La Torre, creci&oacute; hasta convertirse 
                en una planta de producci&oacute;n con m&aacute;s de 30 productores locales y una red amplia de colaboradores.
            </p>

            <p>
                Hoy la segunda generaci&oacute;n de la familia lidera la empresa con valores de integridad, creatividad 
                y solidaridad, ofreciendo una variedad de productos, quesos de vaca y cabra, yogures, entre otros,
                que refleja nuestro compromiso con la tradici&oacute;n, la innovaci&oacute;n y el bienestar de nuestra comunidad.
            </p>
        </div>
    </div>
</main>
