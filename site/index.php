...
<div class="titulo-principal-pagina">
    <h2>Bienvenidos a L&aacute;cteos Don Joaqu&iacute;n</h2>
</div>

<section class="bienvenida-contenedor">
    
    <div class="bienvenida-texto">
       <h2>Descubra L&aacute;cteos Don Joaqu&iacute;n</h2>
        <p>Bienvenidos a L&aacute;cteos Don Joaqu&iacute;n, una empresa paname&ntilde;a comprometida en llevar a su mesa productos frescos, naturales y de la m&aacute;s alta calidad. Nuestra pasi&oacute;n por la leche y el queso nos impulsa a crear productos nutritivos y deliciosos, pensados para el disfrute de toda la familia.</p>
        <p>Desde nuestras granjas hasta su hogar, cada producto es elaborado con esmero y dedicaci&oacute;n, respetando la tradici&oacute;n familiar y los m&aacute;s altos est&aacute;ndares de excelencia. Descubra nuestra variedad de leches y quesos y disfrute de un sabor que refleja nuestra experiencia y cuidado en cada detalle.</p>
     </div>
    
    <div class="bienvenida-imagen">
        <img src="<?= Yii::$app->request->baseUrl ?>/images/stock/granjero.png" alt="granjero viendo al horizonte">
    </div>
...
<div class="metas-contenedor">
    <img src="<?= Yii::$app->request->baseUrl ?>/images/stock/vaca_acariciada.png" alt="una vaca siendo acariciada">

    <section class="metas">
        <div class="metas-texto-wrapper">
    <p>En L&aacute;cteos Don Joaqu&iacute;n, nuestra meta principal es ofrecer productos l&aacute;cteos de la m&aacute;s alta calidad, que sean frescos, naturales y nutritivos para toda la familia. Cada proceso de producci&oacute;n est&aacute; cuidadosamente supervisado para garantizar que la leche y los quesos lleguen a su mesa con el mejor sabor y la mayor seguridad.</p>
    <p>Adem&aacute;s, buscamos innovar constantemente, incorporando tecnolog&iacute;a y pr&aacute;cticas sostenibles que nos permitan cuidar el medio ambiente y garantizar el bienestar del ganado. Queremos que nuestros clientes conf&iacute;en plenamente en nuestros productos y que cada bocado refleje nuestra pasi&oacute;n por la excelencia y la tradici&oacute;n familiar.</p>
    <p>Nos esforzamos por ser referentes en la industria l&aacute;ctea de Panam&aacute;, promoviendo la salud, el bienestar y la satisfacci&oacute;n de nuestros clientes. Nuestro compromiso con la calidad, la transparencia y la responsabilidad social nos impulsa a superar cada d&iacute;a nuestras propias expectativas y a mantenernos fieles a los valores que nos han caracterizado desde nuestros inicios.</p>
</div>
...
<div class="carrusel-wrapper"> 
    ...
    <section class="carrusel3">
        <div class="card">
    <img src="<?= Yii::$app->request->baseUrl ?>/images/fincas/1.jpg" alt="fincas1">
    <h3>Finca de Grado A</h3>
    <p>Santa Genoveva es un ejemplo de ganader&iacute;a moderna, tecnificada y de alta productividad. Representa la m&aacute;xima inversi&oacute;n y eficiencia.</p>
</div>
<div class="card">
    <img src="<?= Yii::$app->request->baseUrl ?>/images/fincas/2.jpg" alt="fincas2">
    <h3>Finca de Grado B</h3>
    <p>El Recuerdo es una finca ganadera tradicional y funcional. Es productiva y rentable, pero con margen de mejora mediante la tecnificaci&oacute;n.</p>
</div>
<div class="card">
    <img src="<?= Yii::$app->request->baseUrl ?>/images/fincas/3.png" alt="fincas3">
    <h3>Finca de Grado C</h3>
    <p>La Fortuna es una finca de ganader&iacute;a extensiva y de subsistencia. Requiere una inversi&oacute;n grande y urgente en rehabilitaci&oacute;n para ser productiva y sostenible.</p>
</div>
<div class="card">
    <img src="<?= Yii::$app->request->baseUrl ?>/images/fincas/4.jpg" alt="fincas4">
    <h3>Finca de Grado D</h3>
    <p>El Manantial es una finca en desarrollo, enfocada en la implementaci&oacute;n de tecnolog&iacute;as sostenibles y pr&aacute;cticas modernas para alcanzar productividad y eficiencia a largo plazo.</p>
</div>

    </section>
    <button class="carrusel-btn next">&gt;</button>
    <script src="<?= Yii::$app->request->baseUrl ?>/js/index.js"></script>
</div>
